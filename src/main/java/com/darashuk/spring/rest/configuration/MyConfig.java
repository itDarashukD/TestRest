package com.darashuk.spring.rest.configuration;
...
@Configuration
@ComponentScan(basePackages = "com.darashuk.spring.rest")
@EnableWebMvc
...
public class MyConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.darashuk.spring.rest.entity");
